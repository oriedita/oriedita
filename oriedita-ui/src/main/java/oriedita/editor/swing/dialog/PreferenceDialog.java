...
public class PreferenceDialog extends JDialog {
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setMinimumSize(new Dimension(490, 400));
        ...
        panel1.setLayout(new GridLayoutManager(1, 4, new Insets(0, 0, 0, 10), -1, -1));
        ...
        panel1.add(restoreDefaultsButton, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        panels2Panel = new JPanel();
        panels2Panel.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), 10, -1));
        panel1.add(panels2Panel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        topPanel = new JPanel();
        topPanel.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        topPanel.setMinimumSize(new Dimension(507, 300));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        display2Panel.add(mouseLabel, gbc);
        CPLabel = new JLabel();
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        display2Panel.add(offsetCB, gbc);
