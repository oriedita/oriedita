...
public class PreferenceDialog extends JDialog {
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setMinimumSize(new Dimension(490, 465));
        ...
        appearance2Panel.add(label2, gbc);
        final JLabel label3 = new JLabel();
        label3.setText(" Live aux width: ");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        ...
        label6.setText(" Main grid color: ");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.weightx = 1.0;
        ...
        label8.setText(" Grid line width: ");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.weightx = 1.0;
