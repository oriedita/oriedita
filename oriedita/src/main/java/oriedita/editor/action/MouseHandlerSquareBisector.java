...
public class MouseHandlerSquareBisector extends BaseMouseHandlerInputRestricted {
    ...
    public void mousePressed(Point p0) {
        ...
        if(d.getClosestPoint(p).distance(p) > d.selectionDistance && (d.lineStep.isEmpty() || d.lineStep.get(0).determineLength() > 0)){
        ...
        else if (d.lineStep.isEmpty() || d.lineStep.get(0).determineLength() <= 0.0){
            if (d.lineStep.size() <= 2) {
