...
public class MouseHandlerCircleDrawFree extends StepMouseHandler<CircleDrawFreeStep> {
    ...
    public MouseHandlerCircleDrawFree() {
        ...
        steps.addNode(ObjCoordStepNode.createNode(CircleDrawFreeStep.CLICK_DRAG_POINT, this::move_click_drag_point, (p) -> {
    ...
    public void drawPreview(Graphics2D g2, Camera camera, DrawingSettings settings) {
        ...
        DrawingUtil.drawLineStep(g2, previewRadiusSegment, camera, settings.getLineWidth());
    }
