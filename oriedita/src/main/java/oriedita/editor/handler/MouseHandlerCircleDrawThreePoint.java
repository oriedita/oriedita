...
public class MouseHandlerCircleDrawThreePoint extends StepMouseHandler<CircleDrawThreePointStep> {
    ...
    public MouseHandlerCircleDrawThreePoint() {
        ...
        steps.addNode(ObjCoordStepNode.createNode_MD_R(CircleDrawThreePointStep.SELECT_POINT_1, this::move_drag_select_point_1,
                this::release_select_point_1));
        steps.addNode(ObjCoordStepNode.createNode_MD_R(CircleDrawThreePointStep.SELECT_POINT_2, this::move_drag_select_point_2,
                this::release_select_point_2));
        steps.addNode(ObjCoordStepNode.createNode_MD_R(CircleDrawThreePointStep.SELECT_POINT_3, this::move_drag_select_point_3,
