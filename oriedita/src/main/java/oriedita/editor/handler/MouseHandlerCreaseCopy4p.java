...
public class MouseHandlerCreaseCopy4p extends StepMouseHandler<CreaseCopy4pStep> {
    ...
    @Inject
    public MouseHandlerCreaseCopy4p() {
        super(CreaseCopy4pStep.SELECT_2_ORIGINAL_POINTS);
        steps.addNode(ObjCoordStepNode.createNode_MD_R(CreaseCopy4pStep.SELECT_2_ORIGINAL_POINTS,
                this::move_drag_select_2_original_points, this::release_select_2_original_points));
        steps.addNode(ObjCoordStepNode.createNode_MD_R(CreaseCopy4pStep.SELECT_2_TARGET_POINTS,
    ...
    private CreaseCopy4pStep release_select_2_original_points(Point p) {
        if (originalPoint1.distance(d.getClosestPoint(originalPoint1)) > d.getSelectionDistance()) {
            originalPoint1 = null;
            return CreaseCopy4pStep.SELECT_2_ORIGINAL_POINTS;
        }
        if (!isFirstSelected) {
    ...
    private CreaseCopy4pStep release_select_2_target_points(Point p) {
