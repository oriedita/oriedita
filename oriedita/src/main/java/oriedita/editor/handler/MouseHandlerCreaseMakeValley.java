...
public class MouseHandlerCreaseMakeValley extends StepMouseHandler<MouseHandlerCreaseMakeValley.Step> {
    @Inject
    ...
    private void makeEdge(Collection<LineSegment> lines) {
        ...
        d.getFoldLineSet().setColor(lines, LineColor.BLUE_2);
        d.fix2();
        d.record();
    }
}
