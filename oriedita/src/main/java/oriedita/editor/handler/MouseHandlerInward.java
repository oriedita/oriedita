...
public class MouseHandlerInward extends StepMouseHandler<InwardStep> {
    ...
    public MouseHandlerInward() {
        ...
        steps.addNode(ObjCoordStepNode.createNode_MD_R(InwardStep.POINT_1, this::move_drag_select_point_1,
                this::release_select_point_1));
        steps.addNode(ObjCoordStepNode.createNode_MD_R(InwardStep.POINT_2, this::move_drag_select_point_2,
                this::release_select_point_2));
        steps.addNode(ObjCoordStepNode.createNode_MD_R(InwardStep.POINT_3, this::move_drag_select_point_3,
    ...
    public void drawPreview(Graphics2D g2, Camera camera, DrawingSettings settings) {
        ...
        DrawingUtil.drawStepVertex(g2, p3, d.getLineColor(), camera);
    }
