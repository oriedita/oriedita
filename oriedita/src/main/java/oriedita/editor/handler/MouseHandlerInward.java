...
public class MouseHandlerInward extends StepMouseHandler<InwardStep> {
    ...
    public MouseHandlerInward() {
        ...
        steps.addNode(StepNode.createNode_MD_R(InwardStep.POINT_1, this::move_drag_select_point_1,
                this::release_select_point_1));
        steps.addNode(StepNode.createNode_MD_R(InwardStep.POINT_2, this::move_drag_select_point_2,
                this::release_select_point_2));
        steps.addNode(StepNode.createNode_MD_R(InwardStep.POINT_3, this::move_drag_select_point_3,
