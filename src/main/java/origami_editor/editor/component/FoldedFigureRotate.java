...
public class FoldedFigureRotate extends JPanel {
    ...
    public FoldedFigureRotate(App app) {
        ...
        foldedFigureRotateSetButton.addActionListener(e -> foldedFigureModel.setRotation(OritaCalc.angle_between_m180_180(app.measuresModel.string2double(foldedFigureRotateTextField.getText(), foldedFigureModel.getRotation()))));
